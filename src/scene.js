...
export function initPost() {
  const composer = new EffectComposer(store.renderer);
  composer.setPixelRatio(store.renderer.getPixelRatio());
  composer.setSize(store.sizes.width, store.sizes.height);
